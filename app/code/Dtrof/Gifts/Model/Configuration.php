...
class Configuration  extends \Magento\Framework\Model\AbstractModel implements ConfigurationInterface, IdentityInterface
{
    /**
     * CMS page cache tag
     */
    const CACHE_TAG = 'oyigifts_configuration';

    /**
     * @var string
     */
    protected $_cacheTag = 'oyigifts_configuration';
     ...
     * @var string
     */
    protected $_eventPrefix = 'oyigifts_configuration';
    ...
    {
        $this->_init('Dtrof\Gifts\Model\ResourceModel\Configuration');
    }
